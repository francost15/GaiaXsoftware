...
import { FaEnvelope, FaLock, FaEyeSlash, FaEye, FaApple, FaGoogle } from 'react-icons/fa'
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    {...register("email", { required: "El correo electrónico es requerido", pattern: { value: /^\S+@\S+$/i, message: "Correo electrónico inválido" } })}
                    className="pl-10"
